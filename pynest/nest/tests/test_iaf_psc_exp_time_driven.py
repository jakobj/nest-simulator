...
class TestIafPSCExpTimeDrivenNeuron(unittest.TestCase):
    ...
    def sim(self, *, time_driven):
        ...
        n1 = nest.Create('iaf_psc_exp', 1, {'time_driven': time_driven, 'I_e': 1000.})
        n2 = nest.Create('iaf_psc_exp', 1, {'time_driven': time_driven, 'I_e': 350.})
    ...
    def test_compare_to_event_driven(self):
        ...
        self.assertTrue(np.allclose(res_event_driven['V_m'], res_time_driven['V_m']))
        self.assertTrue(np.allclose(res_event_driven['spike_times'], res_time_driven['spike_times']))
