...
#ifndef TIME_DRIVEN_US_CONNECTION_H
#define TIME_DRIVEN_US_CONNECTION_H
...
class TimeDrivenUSConnection : public Connection< targetidentifierT >
{
...
template < typename targetidentifierT >
void
TimeDrivenUSConnection< targetidentifierT >::get_status(
...
template < typename targetidentifierT >
void
TimeDrivenUSConnection< targetidentifierT >::set_status(
...
template < typename targetidentifierT >
void
TimeDrivenUSConnection< targetidentifierT >::init_buffers()
{
...
template < typename targetidentifierT >
void
TimeDrivenUSConnection< targetidentifierT >::init_propagators()
{
  const double h = Time::get_resolution().get_ms();
  P11_ = std::exp( -h / tau_ );
  P22_ = std::exp( -h / Tau_ );
...
#endif /* #ifndef TIME_DRIVEN_US_CONNECTION_H */
