...
void
nest::music_rate_out_proxy::Parameters_::set( const DictionaryDatum& d,
  State_& s )
{
...
void
nest::music_rate_out_proxy::State_::set( const DictionaryDatum&,
  const Parameters_& )
{
}
