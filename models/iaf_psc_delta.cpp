...
void
nest::iaf_psc_delta::handle( const double weight, const int multiplicity, const long stamp_steps, const long delay_steps, const rport rp, const double offset, const index sender_gid )
{
  ...
  B_.spikes_.add_value( rel_delivery_steps, weight * multiplicity );
}
